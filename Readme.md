...
<ol>
  <li> Child pornography, including simulated and written child pornography;
  <li> Threats against another user or specific person;
  <li> Slander and libel, i.e., specific untrue factual allegations about any person;
  <li> Hate speech, i.e., advocating genocide or incitement of hatred against any identifiable group;
  <li> Harassment, i.e., stalking, doxxing, etc.;
  <li> Copyright infringement, including links to things that are infringements of copyright, such as scans of manga, game torrents, and so on;
  <li> Obscene material
</ol>
...
<h3>2. Unacceptable Content</h3>
  ...
  <ol>
    <li> Depicts, appears to depict, or describes children unclothed or in a sexual fashion;
    <li> Expresses sexual intention or desire or imputes a sexual act or any sexual connotation toward minors;
    <li> Depicts or explicitly describes adults engaged in sexual acts or otherwise fully naked;
    <li> Depicts or explicitly describes anyone, or any animal, in a state of extreme injury or physical trauma;
    <li> Expresses advocacy, promotion, or other comment that suggests that any person should be, or deserves to be, the victim of any violent, degrading, or sexual act. 
</ol>
...
<h3>3. Hate Speech</h3>
  ...
  <ol>
    <li> The promotion or advocacy of extermination, torture, maiming, or other violent acts directed against a group of people, by race, gender, religion, sexual orientation, nationality, or otherwise;
    <li> The promotion or advocacy of harassment or violence against any specific individual person for any reason;
    <li> The hateful or pejorative use of slurs or other language, whether based on race, ethnicity, gender, sexual orientation, or otherwise; 
  </ol>
...
<h3>4. Harrassment</h3>
  ...
  <ol>
    <li> Using the conversation system to send unwanted private messages to another user;
    <li> Posting personal attacks which go beyond the level of what might reasonably be expressed in frustration in the course of a debate;
    <li> Participating in a discussion solely for the purpose of attacking another user;
    <li> Making public private or personal information without the approval everyone concerned, such as names and addresses, photos, or material posted with an expectation of privacy (such as conversations or restricted-access forums);
    <li> Saying that you have another user on ignore;
    <li> Threatening to report another user
  </ol>
  

<h3>5. Disruptive Behaviour & Spamming</h3>
...
You agree you will not do anything considered to be disruptive or spamming, including, but not limited to:
  <ol>
    ...
    <li> Piling on another user with additional vitriol, complaints, praise, etc.;
    <li> Posting spoilers where they are inappropriate;
    <li> Debating in bad faith;
    <li> Participating in a discussion with the intent or effect of disrupting it, such as by posting off-topic material;
    <li> Challenging Staff decisions in the location where they were made;
    <li> Encouraging any other person to do anything against this Compact
  </ol>
...
<h3>1. Formal Appeals</h3>
  ...
  <ol>
    ...
    <li> A quote of any messages from the Staff concerning the infraction;
  ...
  <ol>
      ...
      <li> Altering the severity of the Staff action, in either direction;
      <li> Performing additional Staff actions
  </ol>
...
<h3>5. Community Council</h3>
  ...
  <ol>
    <li> Nomination phase: Any user in good standing may nominate any two other users in good standing. The twenty-four users with the most nominations will move on to the ballot stage. In the event of a tie, the first to be nominated wins.
    <li> Users will vote on the twenty-four top candidates from the nomination phase. Users may vote for as many of the twenty-four candidates as they wish. The top twelve will become Community Councillors. In the event of a tie, a giant green space monster will eat you.
  </ol>
  ...
  <ol>
    <li> Any Councillor who has been idle in the performance of their duties without approval for three consecutive Tribunals may be removed by a simple majority vote of the Directors;
    <li> Any Councillor may be removed for cause by the Community Council, after presentation of an appropriate case in a Tribunal
  </ol>
...
<h3>6. Code of Conduct</h3>
  ...
  <ol>
    <li> Not moderate or judge discussions they are involved in unless urgently required;
    <li> Not use any privileges extended to them to harass or suppress legitimate discussion;
    <li> Respect user confidentiality and privacy at all times
  </ol>
